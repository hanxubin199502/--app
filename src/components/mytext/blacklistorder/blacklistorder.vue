<template>
  <div class="blacklistorder">
      <div class="zhegai" v-if="zhegai" @click="zhegaiclick"></div>
     <div class="blackbanner">
          <div class="loginhead flex">
            <div class="close" @click="backclick"><img src="../../../assets/hmd_back@2x.png" alt=""></div>
            <div class="loginname">黑名单风险检测</div>
            <div></div>
          </div>
          <div class="welcomelogin">网贷被拒，90%的原因</div>
          <div class="welcomesong">在这里</div>
          <div class="welcometext">30秒查清网贷被拒原因</div>
     </div>
     <div class="blacklist">
        <div class="blacklisttitle">请输入查询对象身份信息</div>
        <div class="submitinformation flex" :class="{bigitem:changestyle}">
             <div class="lconimg" v-show='userimgurl'>
                 <img src="../../../assets/hmd_xm_icon@2x.png" alt="">
             </div>
             <div class="lconimg" v-show='userimg'>
                 <img src="../../../assets/hmd_xm1_icon@2x.png" alt="">
             </div>
             <input 
             type="text" 
             class="inputs"            
             placeholder="姓名"
             v-model="username"><img src="../../../assets/hmd_delete_icon@2x.png" @click="onUpload1()" class="pathClear" alt="">
        </div>
        <div class="badtext" v-show="userimgurl"></div>
        <div class="badtext" v-show="usermonty">姓名不能为空</div>
        <div class="submitinformation ts flex" :class="{bigitem:changestyles}">
             <div class="lconimg" v-show='idimgurl'>
                 <img src="../../../assets/hmd_sfz_icon@2x.png" alt="">
             </div>
              <div class="lconimg" v-show='idimg'>
                 <img src="../../../assets/hmd_sfz1_icon@2x.png" alt="">
             </div>
             <input 
             type="tel" 
             class="inputs"
             ...
             placeholder="身份证号码"
             v-model="useridcard"><img src="../../../assets/hmd_delete_icon@2x.png" @click="onUpload()" class="pathClear" alt="">
        </div>
        <div class="badtexts" v-show="idimgurl"></div>
        <div class="badtexts" v-show="idmonties">请填写正确的身份证号</div>
        <div class="submitinformation ts flex" :class="{bigitem:changestyley}">
             <div class="lconimg" v-show="phoneurl">
                 <img src="../../../assets/hmd_sjh_icon@2x.png" alt="">
             </div>
             <div class="lconimg" v-show="phonemore">
                 <img src="../../../assets/hmd_sjh1_icon@2x.png" alt="">
             </div>
             <input 
             type="tel" 
             class="inputs"
             ...
             v-model="telephone"><img src="../../../assets/hmd_delete_icon@2x.png" @click="onUpload2()" class="pathClear" alt="">
        </div>
        <div class="badtexts" v-show="phoneiets"></div>
        <div class="badtexts" v-show="idmonties">请填写正确的手机号</div>
        <div class="logobtn" @click="xuanzeclick">立即检测</div>
...
.blackbanner{
  ...
  position: relative;
  top: 0;
  background-image: url("../../../assets/hmd_top_bj@2x.png");
